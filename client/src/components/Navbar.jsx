  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        ...
        <div className="w-[72px] h-full rounded-[20px] bg-[#4acd8d] flex justify-center items-center cursor-pointer btn-gradient-border btn-glow">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        <Link to="/profile">
          <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={fairfund} alt="user" className="w-[100%] h-[100%] object-contain " />
          </div>
        </Link>
      </div>
      ...
      {/* Small screen navigation */}
        ...
        <div className="w-[40px] h-[40px] rounded-[10px] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={fairfund} alt="user" className="w-[60%] h-[60%] object-contain" />
          </div>
